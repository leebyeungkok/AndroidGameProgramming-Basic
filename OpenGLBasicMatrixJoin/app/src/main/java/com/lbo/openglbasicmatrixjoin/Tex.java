package com.lbo.openglbasicmatrixjoin;
...
public class Tex {
    ...
    void draw(float[] m) {
        ...
        Matrix.translateM(mTransltionMatrix, 0, 200, 300, 0);
        Matrix.setRotateM(mRotationMatrix, 0, 60, 0,0, -1f);
        Matrix.scaleM(mScaleMatrix, 0, 4, 1, 1.0f);
